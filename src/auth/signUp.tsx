            ...
            <div className="signUp-block flex justify-center items-center min-h-screen">
                <form action="" className="shadow-lg border-gray-200 border rounded px-6 py-4 pb-8 mx-auto max-w-100 w-[90%]">
                    ...
                    <div className="auth-input-blocks flex flex-col mt-2 text-[1.2em]">
                        ...
                        <input type="text" className="px-2 py-1 border rounded" placeholder="Full Name" />
                    </div>
                    ...
                    <button type="submit" className="bg-(--primary-teal) text-white w-full text-2xl font-semibold rounded px-2 py-1.5 mx-auto flex justify-center">Create a account</button>
                    <p className="text-center text-[1.1em] mt-3">Already have an account?<NavLink to='/signIn' className='text-(--primary-teal)'>Sign In</NavLink></p>
                </form>
            </div>
        </>
    )
